...
<main class="container">
      <h1>Display Notes</h1>
      <div>
      <p><a href="index.php">Add Note</a><br> 
        ...
        <form action="displayNotes.php" method="post" enctype="multipart/form-data">
      	<div class="form-group">
      		...
      		<input type="datetime-local" class="form-control" name="beginDate" id="beginDate">
      	</div>
          <div class="form-group">
          ...
          <div class="form-group">
      		<input type="submit" class="btn btn-primary" name="get" value="Get Notes" />
      	</div>
      	<div class="form-group">
      	</div>
          <p><?php echo $notes; ?></p>
