...
class Files {
    ...
    if(isset($_POST['submitButton'])){
        ...
        $oldFileName="{$_POST["fileUpload"]}";
        echo $oldFileName.'<br>';
        $newFileName="{$_POST["enterFileName"]}";
        echo $newFileName.'<br>';
        $newFile="{$_FILES["fileUpload"]}";
        echo $newFileUpload.'<br>';
...
TXT;
	...
	echo 'error^^^File is too big';
      ...
      //$output = $this->addFile($newFileName,$newFileUpload);
